...
var HANDLERS = {
  ...
  'text/html': value => 
    <div className='m_IPython_output m_IPython_output-html'
      dangerouslySetInnerHTML={{__html: 'DEPRECATE;' + value}}/>,
  'image/png': value =>
    <img className='m_IPython_output m_IPython_output-png'
      src={'data:image/png;base64,' + value}/>,
  'text/plain': value =>
    <div className='m_IPython_output m_IPython_output-plain'>
      {plainHtml(value)}
    </div>,
}
